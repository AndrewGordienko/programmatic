...
const out = "output/joint/specification-fragments-v1.json";
...
writeFileSync(
  out,
  JSON.stringify({
    note: "Adaptive calibration, not final evidence. Hole-local fragments derived from finite endpoints of inverse output specifications, including disjoint branches. All complete executions and inverse/fitting work charged; point comparisons and wall time also reported. No oracle syntax or hidden checks guide search.",
    rows,
  }),
);
