...
const out = "output/joint/hole-value-calibration-v1.json";
...
const arms = [
  ...
  { name: "critic-half", options: { holeValue: model, holeValueWeight: 0.5 } },
  { name: "critic-one", options: { holeValue: model, holeValueWeight: 1 } },
  {
    name: "critic-wide",
    options: { holeValue: model, holeValueWeight: 2, holeValueCandidates: 48 },
  },
];
const rows = [];
