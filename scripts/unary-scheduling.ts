...
const out = "output/joint/unary-scheduling-v1.json";
...
const arms = [
  ...
  { name: "unary20", options: { unaryFirst: 0.2 } },
  { name: "unary40", options: { unaryFirst: 0.4 } },
  { name: "unary60", options: { unaryFirst: 0.6 } },
  { name: "unary40-extra", options: { unaryFirst: 0.4, workBudget: 8192 } },
];
const rows = [];
