...
const out = "output/joint/ideal-library-diagnostic-v1.json";
...
const arms = [
  ...
  { name: "relations", options: { relational: true, compiledRelations: true } },
  {
    name: "relations-unary",
    options: { relational: true, compiledRelations: true, unaryFirst: 0.6 },
  },
  {
    name: "local",
    options: {
